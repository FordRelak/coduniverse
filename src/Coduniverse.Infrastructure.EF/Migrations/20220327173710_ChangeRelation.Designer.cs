...
namespace Coduniverse.Infrastructure.EF.Migrations
{
    ...
    [Migration("20220327173710_ChangeRelation")]
            ...
            modelBuilder.Entity("Coduniverse.Domain.SpaceObject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 1237780259,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 3, 27, 17, 37, 9, 812, DateTimeKind.Unspecified).AddTicks(9817), new TimeSpan(0, 0, 0, 0, 0)),
                            Diameter = 1548148094,
                            Mass = 1755329019,
                            Name = "Solar",
                            StarSystemId = new Guid("e8e87f06-eb9e-40e5-a9ca-2740da47bf61"),
                            Type = 0,
                            UpdatedAt = new DateTimeOffset(new DateTime(2022, 3, 27, 17, 37, 9, 812, DateTimeKind.Unspecified).AddTicks(9817), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
