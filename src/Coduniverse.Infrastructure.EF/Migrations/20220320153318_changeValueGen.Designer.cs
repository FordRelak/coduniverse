...
namespace Coduniverse.Infrastructure.EF.Migrations
{
    ...
    [Migration("20220320153318_changeValueGen")]
    partial class changeValueGen
    {
            ...
            modelBuilder.Entity("Coduniverse.Domain.SpaceObject", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 33, 18, 567, DateTimeKind.Unspecified).AddTicks(8591), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Solar",
                            StarSystemId = new Guid("e8e87f06-eb9e-40e5-a9ca-2740da47bf61"),
                            Type = 0,
                            UpdatedDateTime = new DateTimeOffset(new DateTime(2022, 3, 20, 15, 33, 18, 567, DateTimeKind.Unspecified).AddTicks(8591), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
